            ...
            <div class="px-4 pt-2 pb-4 space-y-1">
                ...
                <div>
                    ...
                    <div x-show="debtsOpen" x-collapse class="pl-4 space-y-1 mt-1">
                        <a href="{{ route('debts') }}" wire:navigate.hover @click="mobileMenuOpen = false; Livewire.dispatch('setView', { view: 'overview' })" class="block px-4 py-2 text-sm rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800">
                            {{ __('app.overview') }}
                        </a>
                        <a href="{{ route('debts') }}" wire:navigate.hover @click="mobileMenuOpen = false; Livewire.dispatch('setView', { view: 'create' })" class="block px-4 py-2 text-sm rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800">
                            {{ __('app.add_debt') }}
                        </a>
                        <a href="{{ route('debts') }}" wire:navigate.hover @click="mobileMenuOpen = false; Livewire.dispatch('setView', { view: 'progress' })" class="block px-4 py-2 text-sm rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800">
                            {{ __('app.progress') }}
                        </a>
                        <a href="{{ route('debts') }}" wire:navigate.hover @click="mobileMenuOpen = false; Livewire.dispatch('setView', { view: 'insights' })" class="block px-4 py-2 text-sm rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800">
                            {{ __('app.insights') }}
                        </a>
                        <a href="{{ route('debts') }}" wire:navigate.hover @click="mobileMenuOpen = false; Livewire.dispatch('setView', { view: 'reconciliations' })" class="block px-4 py-2 text-sm rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800">
                ...
                {{-- Settings Link --}}
                <div class="pt-2">
                    <a href="{{ route('settings') }}" wire:navigate.hover @click="mobileMenuOpen = false" class="flex items-center gap-3 px-4 py-3 rounded-xl text-base font-medium {{ request()->routeIs('settings') ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }} transition">
