                    ...
                    <div class="flex flex-wrap gap-3 pt-4 border-t border-slate-200/50 dark:border-slate-700/50">
                        ...
                        @if($isConfigured)
                            <button
                                ...
                                class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:text-rose-600 hover:border-rose-300 dark:hover:text-rose-400 dark:hover:border-rose-800 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 transition-all cursor-pointer"
                            >
