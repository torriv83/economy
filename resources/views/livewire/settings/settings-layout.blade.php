<div>
    ...
    <x-sidebar :section-title="__('app.settings')">
        ...
        <x-sidebar-item action="showBuffer" :label="__('app.buffer_settings')"
            :active="$currentView === 'buffer'" active-color="blue"
    ...
    <div class="animate-fade-in-up">
        ...
        @elseif ($currentView === 'buffer')
            <livewire:settings.buffer-settings />
